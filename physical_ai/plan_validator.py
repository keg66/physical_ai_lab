...
class PlanValidator:
    def validate(self, skill_plan: SkillPlan, world_state: WorldState) -> bool:
...
def validate_plan(plan: SkillPlan, world_state: WorldState) -> bool:
    return PlanValidator().validate(plan, world_state)
